...
export class HtmlSplitter {
   ...
   * stream.
   */
  split(fileTypes?: string[]): Transform {
    fileTypes = fileTypes || ['css', 'js'];
    return new HtmlSplitTransform(this, fileTypes);
  }
   ...
   * stream.
   */
  rejoin(fileTypes?: string[]): Transform {
    fileTypes = fileTypes || ['css', 'js'];
    return new HtmlRejoinTransform(this, fileTypes);
  }
...
class HtmlSplitTransform extends Transform {
  ...
  constructor(project: HtmlSplitter, fileTypes: string[]) {
